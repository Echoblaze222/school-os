// src/app/dashboard/nurse/meetings/page.tsx
...
export default async function NurseMeetingsPage() {
  ...
  const isNurse = await hasActiveAppointment(supabase, user.id, (profile as any).school_id, 'nurse')
  ...
  return (
    <StaffMeetingsClient
      userId={user.id} schoolId={schoolId} role="nurse"
