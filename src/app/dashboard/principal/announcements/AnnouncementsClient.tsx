...
// ── Main Component ────────────────────────────────────────
export default function AnnouncementsClient({ announcements: initialAnnouncements, classOptions, creatorId, creatorName }: Props) {
  ...
  async function handleSubmit() {
    ...
    const newRow: AnnouncementRow = {
      ...
      created_by_name: data.profiles?.full_name ?? creatorName,
    }
