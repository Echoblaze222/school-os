    ...
    <RolePageWrapper userId={userId} role="principal" profile={profile} school={school} title="Reports">
      ...
      {error && (
        <div style={{ padding: '10px 14px', background: '#EF444415', border: '1px solid #EF444440',
          borderRadius: 8, marginBottom: 'var(--space-4)', fontSize: '0.8rem', color: '#EF4444', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <>
                  ...
                  <div style={{ background: 'var(--glass-bg)', border: '1px solid var(--glass-border)',
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between',
                      ...
                      <p style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--text-primary)', margin: 0 }}>
                        Collection Rate
                      </p>
                    ...
                    <Bar value={report.paidCount} max={report.studentCount || 1} color={sc} />
                    <p style={{ fontSize: '0.72rem', color: 'var(--text-muted)', margin: 'var(--space-3) 0 0' }}>
                    ...
                    : Object.entries(report.byClass)
                        ...
                        .map(([cl, vals]: any) => (
                          <div key={cl} style={{ background: 'var(--glass-bg)',
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between',
                              alignItems: 'baseline', marginBottom: 'var(--space-3)' }}>
                              <p style={{ fontSize: '0.88rem', fontWeight: 800, color: 'var(--text-primary)', margin: 0 }}>{cl}</p>
                              {vals.expected > 0 && (
                    ...
                    : Object.entries(report.byType)
                        ...
                        .map(([type, amount]: any) => (
                          <div key={type} style={{ background: 'var(--glass-bg)',
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between',
                              alignItems: 'baseline', marginBottom: 'var(--space-3)' }}>
                              <p style={{ fontSize: '0.88rem', fontWeight: 800, color: 'var(--text-primary)', margin: 0, textTransform: 'capitalize' }}>
