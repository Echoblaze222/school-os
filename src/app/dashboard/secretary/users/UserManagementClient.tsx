...
import type { ManagedUser, ClassOption, UserRole } from './page'
                ...
                <>
                  ...
                  {selected.role === 'teacher' && selected.subjects.length > 0 && (
                    <div className={styles.drawerSection}>
                      ...
                      <div className={styles.drawerField}><span className={styles.drawerFieldLabel}>Teaches</span><span className={styles.drawerFieldValue}>{selected.subjects.join(', ')}</span></div>
                    </div>
                  )}
                </>
              ) : (
