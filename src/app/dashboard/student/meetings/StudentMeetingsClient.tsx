...
export default function StudentMeetingsClient({
  userId, schoolId, classId, meetings: initialMeetings, fetchError, profile, school,
}: Props) {
  ...
  const relevant = meetings.filter(m =>
    m.target_audience === 'specific_class' && m.target_class_id === classId
  )
      ...
      <div className={styles.listMain}>
        ...
        {!classId && !fetchError && (
          <div className={styles.errorBanner}>
            ...
            You are not currently assigned to a class. Meetings will appear once your class is set.
          </div>
        )}

        {relevant.length === 0 && !fetchError && classId ? (
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyBody}>When your school schedules a meeting for your class, it will appear here.</p>
          </div>
        ) : (
          <>
            {upcoming.length > 0 && (
