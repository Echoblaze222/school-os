...
export default function TeacherMeetingsClient({
  ...
  const relevant = meetings.filter(m =>
    ['all_teachers', 'all_staff'].includes(m.target_audience)
  )
  ...
  return (
    <RoleSubHeader
      ...
      school={school}
      title="Meetings"
      featureGroups={TEACHER_FEATURE_GROUPS}
    >
      <div className={styles.listMain}>
        ...
        {relevant.length === 0 && !fetchError ? (
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyBody}>When the principal schedules a staff or teacher meeting, it will appear here.</p>
          </div>
        ) : (
          <>
            {upcoming.length > 0 && (
