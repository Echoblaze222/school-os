...
// FIX: `term` is a Postgres ENUM accepting only 'first' | 'second' | 'third'.
// Previously this sent 'First Term' straight to the DB, which Postgres
// rejected with "invalid input value for enum term". We keep friendly
// labels for display/tabs, but store+send only the enum value.
        ...
        <>
          ...
          {!selectedClass?.class_subject_id ? (
            ...
            <div className={styles.empty}>
              ...
              <p>No topics for {TERM_LABEL[term] ?? term} yet. Add your first topic above.</p>
            </div>
          ) : (
      ...
      {tab === 'pdf' && (
        <div className={styles.pdfTab}>
          <p className={styles.pdfDesc}>
            Upload the official {TERM_LABEL[term] ?? term} syllabus PDF for <strong>{selectedClass?.class_name}</strong>.
          ...
          {syllabusPdf ? (
            <div className={styles.pdfCard}>
              ...
              <div className={styles.pdfInfo}>
                <p className={styles.pdfName}>{TERM_LABEL[term] ?? term} Syllabus</p>
