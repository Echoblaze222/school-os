...
export function CrownIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function BellOffIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
      <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
...
export function StatusDotIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
...
export function BanIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
      <circle cx="12" cy="12" r="10"/>
...
export function BankIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function StethoscopeIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function BulbIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
      <path d="M9 18h6"/>
      <path d="M10 22h4"/>
...
export function TargetIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function HandshakeIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function CalculatorIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function PartyPopperIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
...
export function WaveIcon({ size = 24, color = 'currentColor', strokeWidth = 1.75 }: IconProps) {
  return (
    <svg {...ic(size, color, strokeWidth)}>
